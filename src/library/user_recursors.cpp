...
void initialize_user_recursors() {
    ...
    register_attribute(unsigned_params_attribute("recursor", "user defined recursor", [](environment const & env, io_state const & ios, name const & n, unsigned_params_attribute_data const & data, bool persistent) {
