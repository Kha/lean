...
modify (λ s, tactic_state.set_options s (options.set_bool (tactic_state.get_options s) n v))
>> skip

meta def set_nat_option (n : name) (v : nat) : tactic unit :=
modify (λ s, tactic_state.set_options s (options.set_nat (tactic_state.get_options s) n v))
>> skip

meta def set_string_option (n : name) (v : string) : tactic unit :=
modify (λ s, tactic_state.set_options s (options.set_string (tactic_state.get_options s) n v))
>> skip
